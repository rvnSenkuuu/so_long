...
/*   Updated: 2024/07/29 10:51:08 by tkara2           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player_up(t_game *game, t_map *map)
{
	...
	if (map->map[map->player->x - 1][map->player->y] == 'E'
		...
		return ;
	if (map->map[map->player->x - 1][map->player->y] == 'B')
		game_condition(game, GAME_LOSE);
	else if (map->map[map->player->x - 1][map->player->y] == '1')
		return ;
...
void	move_player_right(t_game *game, t_map *map)
{
	...
	if (map->map[map->player->x][map->player->y + 1] == 'E'
		&& map->count_collectible != 0)
		return ;
	if (map->map[map->player->x][map->player->y + 1] == 'B')
		game_condition(game, GAME_LOSE);
	else if (map->map[map->player->x][map->player->y + 1] == '1')
		return ;
	else if (map->count_collectible == 0
